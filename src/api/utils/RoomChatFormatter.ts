...
export const RoomChatFormatter = (content: string) =>
{
    ...
    content.toLowerCase().includes('onmouseover') ||
    content.toLowerCase().includes('oncontextmenu') ||
    content.toLowerCase().includes('ondblclick') ||
    content.toLowerCase().includes('onmousedown') ||
    content.toLowerCase().includes('onmouseenter') ||
    content.toLowerCase().includes('onmouseleave') ||
    content.toLowerCase().includes('onmousemove') ||
    content.toLowerCase().includes('onmouseout') ||
    content.toLowerCase().includes('onmouseup') ||
    content.toLowerCase().includes('onmouseup') ||
    content.toLowerCase().includes('width: ') ||
    ...
    else if(content.includes(GetConfiguration<string>('audio.sounds.url')))
    {
