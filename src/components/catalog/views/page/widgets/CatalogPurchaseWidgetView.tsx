...
export const CatalogPurchaseWidgetView: FC<CatalogPurchaseWidgetViewProps> = props =>
{
    ...
    useEffect(() =>
    {
        ...
        if((purchaseState === CatalogPurchaseState.CONFIRM) || (purchaseState === CatalogPurchaseState.FAILED) || (purchaseState === CatalogPurchaseState.PURCHASE))
        {
            timeout = window.setTimeout(() => setPurchaseState(CatalogPurchaseState.NONE), 3000);
        }
